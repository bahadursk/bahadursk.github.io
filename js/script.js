...
------------------------------------------------------*/
    ...
    // main directions
      map = new GMaps({
        el: '#map', lat: 23.2848192, lng: 77.2707151, zoom: 13, zoomControl : true, 
        zoomControlOpt: { style : 'SMALL', position: 'TOP_LEFT' }, panControl : false, scrollwheel: false
      });
    // add address markers
    map.addMarker({ lat: 23.2848192, lng: 77.2707151, title: 'Indian Institute of Science Education and Research Bhopal',
      infoWindow: { content: '<p>IISER Bhopal, Indore Bypass Road, Bhauri, Bhopal, Madhya Pradesh 462066</p>' } });
